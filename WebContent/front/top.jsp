...
<div class="container-fluid">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#">时事新闻-综合管理平台</a>
	</div>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<ul class="nav navbar-nav navbar-right">
				<li><a target="_parent" href="${pageContext.request.contextPath}/hello">首页</a></li>
				<li role="separator" class="divider"></li>
				<li><a target="_parent" href="${pageContext.request.contextPath}/user?method=logout">退出登录</a></li>

...
<div class="leftMenu">
	<div class="menu">
		<div class="menuParent">
			...
			<div class="menuList">
				<div> <a href="${pageContext.request.contextPath}/user?method=addUI" target="mainAction">用户管理</a></div>
				<div> <a href="${pageContext.request.contextPath}/collect?method=listCollectByPage&currPage=1" target="mainAction">收藏夹</a> </div>
			</div>
		</div>
	</div>
</div>
